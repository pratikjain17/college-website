    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($result->num_rows >0){
            ...
            if($student_password == $student_cpassword){
                ...
                $sql = "INSERT INTO `students` (`student_id`, `student_username`, `student_email`, `student_password`, `student_gender`, `student_photo`, `student_address`, `student_status`, `timestamp`) 
                VALUES (NULL, '$student_username', '$student_email', '$hash_password', '$student_gender', '$student_photo', '$student_address', '0', current_timestamp());";
